...
function loadTipsMessage(a) {
    ...
    window.showWelcomeMessage = function(a) {
        ...
        if (23 < t || 5 >= t) {
            y=a.waifu.hour_tips.t23-5
        } else if(5 < t && 7 >= t){
            y=a.waifu.hour_tips.t5-7
        } else if(7 < t && 11 >= t){
            y=a.waifu.hour_tips.t7-11
        } else if(11 < t && 14 >= t){
            y=a.waifu.hour_tips.t11-14
        } else if(14 < t && 17 >= t){
            y=a.waifu.hour_tips.t14-17
        } else if(17 < t && 19 >= t){
            y=a.waifu.hour_tips.t17-19
        }else if(19 < t && 21 >= t){
            y=a.waifu.hour_tips.t19-21
        }else if(21 < t && 23 >= t){
            y=a.waifu.hour_tips.t21-23
        }else{
            y=a.waifu.hour_tips.default
        }
