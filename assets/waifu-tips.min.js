...
function loadModel(a) {
    ...
    // loadlive2d("live2d", live2d_settings.modelAPI + ModelDefine.MODELS[a][c], live2d_settings.showF12Status ? console.log("[Status]", "live2d", "\u6a21\u578b", a + "-" + c, "\u52a0\u8f7d\u5b8c\u6210" + " [Model] " + ModelDefine.MODELS[a][c]) : null)

    // API: https://live2d-widget-ten.vercel.app/api/models/
    // API: https://live2d-widget-ten.vercel.app/api/models/1
    k = live2d_settings.modelAPI + a
    loadlive2d("live2d", k, live2d_settings.showF12Status ? console.log("[Status]", "live2d", "\u6a21\u578b", a + "-" + c, "\u52a0\u8f7d\u5b8c\u6210") : null)
}
...
function loadTipsMessage(a) {
    ...
    $(".waifu-tool .fui-eye").click(function() {c()});  // 人物変更
    $(".waifu-tool .fui-user").click(function() {e()}); // 衣装変更
    $(".waifu-tool .fui-chat").click(function() {k()}); // 文言変更 

    $(".waifu-tool .fui-photo").click(function() {      // 写真撮影
    ...
    $(".waifu-tool .fui-cross").click(function() {     // クローズ
        sessionStorage.removeItem("modelId");
        sessionStorage.removeItem("modelTexturesId");
        showMessage(getRandText(a.waifu.hidden_message), 5E3, !0);
        window.setTimeout(function() {
            $(".waifu").remove()
        }, 1000)
    })
...
live2d_settings.waifuSize = "280x320";
live2d_settings.waifuTipsSize = "240x70";
live2d_settings.waifuFontSize = "12px";
live2d_settings.waifuToolTop = "10px";
live2d_settings.waifuToolFont = "30px";
live2d_settings.waifuToolLine = "40px";
live2d_settings.waifuMinWidth = "0px";     //waifu显示页面的最小宽度
live2d_settings.waifuEdgeSide = "right:0"; //"left:0","right:0"

live2d_settings.waifuDraggable = "axis-x"; //"disable","axis-x","unlimited"
live2d_settings.waifuDraggableRevert = true;

//live2d_settings.modelAPI = "//live2d.fghrsh.net/api/";
live2d_settings.modelAPI = "https://live2d-widget-ten.vercel.app/api/models/";
live2d_settings.modelId = 1;                   // model 从1开始
...
live2d_settings.modelStorage = 1;
