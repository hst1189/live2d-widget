...
function loadTipsMessage(a) {
    function c() {
        var id = g("modelId");
        var msg = a.waifu.model.id[id].message;
    ...
    window.showWelcomeMessage = function(a) {
        ...
        if (23 < t || 5 >= t) {
            y=getRandText(a.waifu.hour_tips.t23-5);
        } else if(5 < t && 7 >= t){
            y=getRandText(a.waifu.hour_tips.t5-7);
        } else if(7 < t && 11 >= t){
            y=getRandText(a.waifu.hour_tips.t7-11);
        } else if(11 < t && 14 >= t){
            y=getRandText(a.waifu.hour_tips.t11-14);
        } else if(14 < t && 17 >= t){
            y=getRandText(a.waifu.hour_tips.t14-17);
        } else if(17 < t && 19 >= t){
            y=getRandText(a.waifu.hour_tips.t17-19);
        } else if(19 < t && 21 >= t){
            y=getRandText(a.waifu.hour_tips.t19-21);
        } else if(21 < t && 23 >= t){
            y=getRandText(a.waifu.hour_tips.t21-23);
        } else{
            y=getRandText(a.waifu.hour_tips.default);
        }
...
live2d_settings.screenshotCaptureName = "save_live2d_" & live2d_settings.modelId & "_" & live2d_settings.modelTexturesId & ".png";
