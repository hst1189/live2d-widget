try {
    ...
    $.ajax({url: '//www.grapehut.us.kg/live2d-widget/assets/waifu-tips.min.js', dataType:"script", cache: true, success: function() {
        $.ajax({url: '//www.grapehut.us.kg/live2d-widget/assets/live2d.min.js', dataType:"script", cache: true, success: function() {
            /* 可直接修改部分参数 */
